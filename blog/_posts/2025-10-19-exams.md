...
<img src="https://s3.amazonaws.com/NARAprodstorage/lz/denver/rg-338/607674/607674_0683_Page_1.jpg" 
     ...
     <figcaption style="font-style: italic; margin-top: 10px;">
          Cybersecurity training session (National Archives, 1981)
     </figcaption>
</figure>
...
In the cybersecurity industry, there are certification exams that gauge a person's knowledge and skill. Some exams are multiple choice, some have hands on labs, and some use a mix of both.  Some exams certify general knowledge while others test for speicfic disciplines, such as penetration testing, reverse engineering, incident handling. Employers like these certifications for the same reason colleges like the SAT. 
...
To prepare for the exam, I completed the companion course taught by [the SysAdmin, Audit, Network, Security (SANS) Institute](https://sans.org).  My particular course was the [SEC 542: Web App Penetration Testing and Ethical Hacking](https://www.sans.org/cyber-security-courses/web-app-penetration-testing-ethical-hacking#laptop-requirements) course. This course is geared toward teaching the skills needed for the test. SANS and GIAC enjoy a symbiotic relatoinship in which one creates the class, the other the exam.  

That SANS course costs $8,780 USD. That is a lot of money; most folks looking to break into or advance in the cybersecurity industry cannot afford that. I'm already in the industry, and I can't afford that (My employer paid for my course).  And the exorbitant tuition is part of the problem.
...
<figure style="text-align:center;">
<img src="https://neillperry.com/assets/img/certs.jpeg" 
     alt="a chart of 481 cybersecurity certifications broken out into different categories; Credit: Paul Jerimy https://pauljerimy.com/security-certification-roadmap/" 
     title="Cybersecurity certifications" 
     style="width:75%; height:auto;" />
     <figcaption>
          Paul Jerimy counted and categorized 481 cybersecurity certifications
     </figcaption>
</figure>
...
GIAC exams measure a candidate's ability to look up answers in a book. You see, GIAC exams are open book, and candidates may bring an armful of books with them into the testing center. For the GWAPT, I lugged in the 7 SANS notebooks. Armed with these materials, I looked up the answer to every question. I breezed through with an 85% score. Passing the GWAPT was discouraging because it was so easy. The nature of the questions reinforced the perception that someone without the course materials would struggle to pass. 

GIAC exams are not a fair test. A nondisclosure agreement prevents me from disclosing specifics, but the SANS course materials give an unfair advantage to those who have them. (Legally, students who complete a SANS course may not share their SANS materials with others.) When I took the GREM exam, I brought in 3 reverse engineering books and my 10,000 word outline that I curated. Although those had great information, they were not enough to pass. Though to be fair, Elias Augusto passed on his own, but he is the exception.  

What is especially frustrating is how much deferrence the cybersecurity industry affords GIAC certifications.  It is not uncommon for companies to list GIAC certifications that are required for a job vacancy.  Recruiters will screen out candidates missing those accredidations from their resume. The industry equates the certification with knowledge, when in reality it corresponds just as much to access to expensive SANS courses.
...
Although I didn't pass the GREM, I developed a pretty strong skill of learning a new domain by myself. Unfortunately, perserverance is not something that I can put on my resume. Given the fierce competition in the job market, candidates who have the right certifications will get interviews over those who do not.  
